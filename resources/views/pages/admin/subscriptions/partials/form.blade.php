...
>
    ...
    <div class="mx-auto max-w-2xl">
        ...
        <div class="mt-6 flex justify-end gap-2">
            <a href="{{ route('admin.subscriptions.index') }}" class="rounded-lg border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-400">{{ __('Bekor qilish') }}</a>
