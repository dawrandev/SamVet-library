...
>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
            <x-admin.form.section :title="__('Sarlavha va havola')">
                <div class="space-y-5">
                    ...
                    <x-admin.form.input name="url" :label="__('Havola')" :value="$preUrl"
                        ...
                        :help="__('Ichki yo‘l, tashqi URL yoki bo‘sh qoldiring (sahifa keyin ulanadi).')" />
                </div>
            </x-admin.form.section>
        </div>

        {{-- O'ng: joylashuv + sozlamalar --}}
        <div class="space-y-6 lg:col-span-1">
            <x-admin.form.section :title="__('Joylashuv')">
                <div class="space-y-5">
                    {{-- Ota menyu (id + label massiv — qo'lda) --}}
                    <div>
