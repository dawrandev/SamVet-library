...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 space-y-6 xl:col-span-4">
            {{-- Parent's own info, shown here too so this page is self-contained
                 (edit those fields via the journal's own form). --}}
            <x-admin.journal-info-panel :journal="$journal" :edit-url="route('admin.journals.edit', $journal)" />
