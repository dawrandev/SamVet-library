{{--
    Article's own fields — journal/issue picker + "Maqola ma'lumotlari". Shared by:
    - the standalone article create/edit form (pages/admin/articles/partials/form.blade.php)
    - the unified "Yangi davriy nashr" form's "Maqola" branch (pages/admin/journals/partials/form.blade.php)

    Expects in scope: $article (nullable), $editing, $isNewspaperForm, $categoryOptions,
    $currentCategory, $resourceFields, $languages, $contributorRoles. The enclosing
    x-data must expose the articleForm() properties (journalName, journalId, issueId,
    external, results, searching, showResults, issues, loadingIssues, search(), pickJournal()).
--}}
