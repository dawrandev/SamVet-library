...
>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        {{-- Right: avtoreferat details --}}
        <x-admin.form.section :title="__('Avtoreferat ma’lumotlari')">
            <div class="space-y-5">
                <x-admin.form.input name="title" :label="__('Avtoreferat nomi')" :value="$avtoreferat?->title" required :placeholder="__('Avtoreferat nomi')" />
                <x-admin.form.input name="author" :label="__('Muallifi')" :value="$avtoreferat?->author" required :placeholder="__('masalan: Aliyev A.')" />
