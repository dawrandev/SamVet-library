...
it('filters the district select to the chosen region and saves the picked district', function () {
    ...
    $readerType = ReaderType::factory()->create();

    $this->browse(function (Browser $browser) use ($admin, $karakalpakstan, $nukus, $urgut, $readerType) {
        $browser->loginAs($admin)
            ...
            ->select('reader_type_id', (string) $readerType->id)
