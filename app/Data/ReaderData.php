...
class ReaderData
{
    public function __construct(
        ...
        public readonly ?int $affiliation_place_id,
        public readonly ?int $affiliation_unit_id,
        public readonly ?int $affiliation_group_id,
    ...
    public static function fromRequest(Request $request): self
    {
        return new self(
            ...
            affiliation_place_id: $request->integer('affiliation_place_id') ?: null,
            affiliation_unit_id: $request->integer('affiliation_unit_id') ?: null,
            affiliation_group_id: $request->integer('affiliation_group_id') ?: null,
    ...
    public function toAttributes(): array
    {
        return [
            ...
            'affiliation_place_id' => $this->affiliation_place_id,
            'affiliation_unit_id' => $this->affiliation_unit_id,
            'affiliation_group_id' => $this->affiliation_group_id,
