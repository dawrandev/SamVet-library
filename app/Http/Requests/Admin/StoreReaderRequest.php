...
class StoreReaderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'affiliation_place_id' => ['nullable', 'integer', 'exists:affiliation_places,id'],
            'affiliation_unit_id' => ['nullable', 'integer', 'exists:affiliation_units,id'],
            'affiliation_group_id' => ['nullable', 'integer', 'exists:affiliation_groups,id'],
    ...
    public function attributes(): array
    {
        return [
            ...
            'affiliation_place_id' => __('Mansublik joyi'),
            'affiliation_unit_id' => __('Mansublik bo‘limi'),
            'affiliation_group_id' => __('Mansublik guruhi'),
            'nationality' => __('Millati'),
            'birth_date' => __('Tug‘ilgan sana'),
            'passport' => __('Passport'),
            'pinfl' => __('JSHSHIR (PINFL)'),
            'gender' => __('Jinsi'),
            'region_id' => __('Viloyat'),
            'district_id' => __('Tuman'),
            'address' => __('Manzil'),
            'phone' => __('Telefon'),
